...
const catalog: Record<string, Translation> = {
  ...
  "Un refugio creado para compartir Monteverde": { en: "A retreat created to share Monteverde", fr: "Un refuge créé pour partager Monteverde", de: "Ein Rückzugsort, um Monteverde zu teilen" },
